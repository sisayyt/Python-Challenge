...
engine = create_engine("sqlite:///Desktop/hawaii.sqlite", echo=False)
...
def calc_temps_2(start='start_date', end='end_date'):      
    start_date = datetime.strptime('2012-02-28', '%Y-%m-%d').date()
    end_date = datetime.strptime('2012-03-05', '%Y-%m-%d').date()
